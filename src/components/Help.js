...
class Help extends React.Component {
  render() {
    return (
      <div className="flex position-absolute w-100 h-100 bg-shade">
        <div
        ...
        >
          ...
          <p>
            In most calculators if you want to type 3 ¾, you would have to enter
            it as "(3+3/4)". Ain't nobody got time for that.
          </p>
          <p>
          ...
          <p>
            ...
            flip through your previous functions.
          </p>
          <p>
